...
<div class="btn-group btn-block">
  ...
  <ul class="dropdown-menu dropdown-menu-right">
    ...
    <c:if test="${grouperRequestContainer.groupContainer.canAdmin }">
      ...
      <%-- ND Issue #6 --%>
      <li><a href="#" onclick="return guiV2link('operation=UiV2GroupProvisioningTarget.groupEditAttributes&groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}'); return false;"
              >Edit provisioning info</a></li>
    </c:if>
